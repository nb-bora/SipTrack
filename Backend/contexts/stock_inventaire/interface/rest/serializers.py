...
class CreerProduitInputSerializer(serializers.Serializer[Any]):
...
class InventaireProduitOutputSerializer(serializers.Serializer[Any]):
...
class AjouterStockInputSerializer(serializers.Serializer[Any]):
    """Entrée pour ajouter du stock."""

    quantite = serializers.IntegerField(min_value=0)


class VendreInputSerializer(serializers.Serializer[Any]):
    """Entrée pour enregistrer une vente."""

    quantite = serializers.IntegerField(min_value=0)


class CorrigerInventaireInputSerializer(serializers.Serializer[Any]):
